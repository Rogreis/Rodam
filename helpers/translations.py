...
class FormatEntry:
    ...
    def Format(self) -> ParagraphExportHtmlType:
        try:
            ...
            # Fallback or default if value is invalid, currently returning NormalParagraph (3) as safe default
            # or you might want to raise error.
    ...
    def __repr__(self):
        return f"<FormatEntry {self.paper}:{self.section}.{self.paragraph} {self.page}.{self.line}>"
