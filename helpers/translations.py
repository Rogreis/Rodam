...
class TTranslations:
    ...
    def load(self, language_id: int) -> Optional[Translation]:
        ...
        translation_name1= "translation.json"
        translation_name2= f"TR{language_id:03d}.json"
        ...
        try:
            with zipfile.ZipFile(zip_path, 'r') as zf:
                ...
                if translation_name1 in file_list:
                    file_to_open = translation_name1
                elif translation_name2 in file_list:
                    file_to_open = translation_name2
                
                if not file_to_open:
                    print(f"No valid translation file found in {zip_path}. Checked: {translation_name1}, {translation_name2}")
                    return None
